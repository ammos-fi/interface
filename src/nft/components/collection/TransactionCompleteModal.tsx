...
import { BackArrowIcon, ChevronUpIcon, LightningBoltIcon, TwitterIcon, AmmosIcon } from 'nft/components/icons'
            ...
            {showPurchasedModal && (
              ...
              >
                <Box className={styles.successModal} onClick={stopPropagation}>
                  <AmmosIcon color={vars.color.pink400} width="36" height="36" className={styles.uniLogo} />
